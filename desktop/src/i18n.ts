...
const zh = {
  ...
  "status.telemetry": "诊断 {arrow}",
  // 接收端方向：本机去听另一台设备（主机）的声音。
  // 与主机视角的 manual.* 分开命名 —— 混用会让用户以为"主机要去连别人"，那正是本次架构要修的误会。
  "connect.title": "连接到主机",
  "connect.role": "本机将作为接收端",
  "connect.hint": "输入主机屏幕上显示的地址。",
  ...
  "set.auto_broadcast": "有人接入时自动开始推流",
  "set.auto_broadcast_hint": "设备接入后立即出声，无需手动开始推流；手动停过的设备不会被自动重启。",
  "set.loading": "（读取中…）",
  ...
  "cap.hint_idle": "要送出声音的播放器（浏览器、音乐软件）需把输出设备设为上面这一项。更换耳机或声卡后，点右侧刷新。",
  "cap.active": "正在采集：{name} · {rate} kHz · {channels} 声道",
  "cap.selected": "当前生效：{name}",
  ...
  "upd.title": "软件更新",
  "upd.hint": "更新需手动检查：AudioLink 不会在后台自动下载或安装 —— 正在推流或录音时被静默重启是不可接受的。",
  "upd.check": "检查更新",
  "upd.checking": "检查中…",
  ...
  "side.local": "本机",
  "side.broadcast": "开始推流",
  "side.broadcast_blocked": "等待设备接入",
  "side.broadcast_blocked_hint": "在对方设备输入上方地址；接入后即可推流",
  "side.broadcasting_waiting": "推流中 · 等待设备接入",
  "side.stop_broadcast": "停止推流",
  "host.address": "本机地址",
  "host.hint": "在对方的设备上输入这个地址即可接入。",
  "host.addr_missing": "未检测到局域网地址",
  "host.hint_missing": "未检测到可用的局域网地址，请确认本机已连接 Wi-Fi 或网线",
  "host.multi_hint": "本机有多个局域网地址，可逐个尝试。",
  "host.role_hint": "本机作为主机，等待对方接入，无需填写对方地址。",
  "host.copy": "复制地址",
  "host.copied": "已复制",
  "devices.title": "正在收听本机的设备",
  "devices.empty": "暂无已连接设备。",
...
const en: Record<MessageKey, string> = {
  ...
  "status.telemetry": "Diagnostics {arrow}",
  "connect.title": "Connect to a host",
  "connect.role": "This device becomes a receiver",
  "connect.hint": "Enter the address shown on the host.",
  ...
  "set.auto_broadcast": "Start streaming automatically when a device joins",
  "set.auto_broadcast_hint": "Audio starts as soon as a device joins - no need to start streaming manually; a device you stopped is not restarted automatically.",
  "set.loading": "(loading…)",
  ...
  "cap.hint_idle": "The player (browser, music app) must output to the device selected above. After swapping headsets or sound cards, hit refresh.",
  "cap.active": "Capturing: {name} · {rate} kHz · {channels} ch",
  "cap.selected": "In effect: {name}",
  ...
  "upd.hint": "Updates are checked manually: AudioLink never downloads or installs in the background - being restarted silently while streaming or recording is not acceptable.",
  ...
  "side.broadcast": "Start streaming",
  "side.broadcast_blocked": "Waiting for a device",
  "side.broadcast_blocked_hint": "Enter the address above on the other device; streaming starts once it joins",
  "side.broadcasting_waiting": "Streaming · waiting for a device",
  "side.stop_broadcast": "Stop streaming",
  "host.address": "This device's address",
  "host.hint": "Enter this address on the other device to join.",
  ...
  "host.multi_hint": "This device has several LAN addresses; try them one by one if needed.",
  "host.role_hint": "This device is the host: it waits to be joined; no address to enter.",
