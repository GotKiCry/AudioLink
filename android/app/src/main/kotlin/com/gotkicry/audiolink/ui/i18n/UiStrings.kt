...
data class UiStrings(
    ...
    val discoveryRefresh: String,
    val discoveryRefreshing: String,
    val discoverySearching: String,
    val discoveryEmpty: String,
    val discoveryHint: String,
    val discoveryError: String,
    val discoveryIncompatible: String,
...
private val Zh = UiStrings(
    ...
    receiveTab = "接收声音",
    sendTab = "发送声音",
    discoveryTitle = "局域网主机",
    discoveryRefresh = "刷新主机",
    ...
    receiverEntryHint = "选择同一局域网的主机，也可以手动输入地址。",
...
private val En = UiStrings(
    ...
    receiveTab = "Receive",
    sendTab = "Send",
    discoveryTitle = "Local hosts",
    discoveryRefresh = "Refresh hosts",
    ...
    receiverEntryHint = "Choose a host on your local network, or enter its address manually.",
    ...
    targetAddress = "Enter host address manually",
