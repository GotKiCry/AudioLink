...
$Tasks = @(
    ...
    @{ T = '[M5] 产品化：托盘/自启/自动更新/双语/双 ABI 发布/合规清单'; M = 'M5'; P = 'P3'; S = 'In Progress'; B = 'docs/05-roadmap.md M5。2026-09-17：双 ABI 发布这一半落地 —— assembleRelease 产出两个按 ABI 的包（arm64-v8a 5.21 MB / armeabi-v7a 3.84 MB，均 V2 签名有效），详见「分 ABI 打包」条目与 docs/42 §9。仍未做：桌面中英双语、绿色版、用户手册（中/英）、故障排查指南、CONTRIBUTING.md；真机安装验收仍受阻。' }
